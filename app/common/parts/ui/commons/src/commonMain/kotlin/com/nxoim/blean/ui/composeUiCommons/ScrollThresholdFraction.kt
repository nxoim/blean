...
class ScrollVisualFactorNestedConnection(
    ...
    private val _fraction = mutableStateOf(0f)
...
fun Modifier.slideUpOnScroll() = slideUpOnScroll(LocalScrollVisualFactor.current)
...
@Composable
@NonRestartableComposable
fun Modifier.slideDownOnScroll() = slideDownOnScroll(LocalScrollVisualFactor.current)
